import { r as reactExports, j as jsxRuntimeExports, Z as React, ae as React$1, X as useInternetIdentity } from "./index-CatDpExm.js";
...
const useAuthStore = create()(
  persist(
    (set) => ({
      ...
      principal: null,
      identity: null,
      setAuth: (identity2, principal) => set({ isAuthenticated: true, principal, identity: identity2 }),
      clearAuth: () => set({ isAuthenticated: false, principal: null, identity: null })
    }),
    {
...
function useAuth() {
  ...
  reactExports.useEffect(() => {
    if (identityAuthenticated && identity2) {
      const principalStr = identity2.getPrincipal().toText();
      setAuth(identity2, principalStr);
    } else if (!identityAuthenticated) {
      clearAuth();
    }
  }, [identity2, identityAuthenticated, setAuth, clearAuth]);
